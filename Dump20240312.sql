...
--
-- Host: localhost    Database: animalhouse
-- ------------------------------------------------------
...
INSERT INTO `rooms` VALUES (1,11,3,'largeroom','просторное и роскошное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(2,12,1,'smallroom',' уютное и комфортное место, где ваш любимец сможет отдохнуть и расслабиться',1),(3,13,2,'mediumroom',' просторное и функциональное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(4,21,1,'smallroom',' уютное и комфортное место, где ваш любимец сможет отдохнуть и расслабиться',1),(5,22,2,'mediumroom',' просторное и функциональное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(6,23,3,'largeroom','просторное и роскошное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(7,31,2,'mediumroom',' просторное и функциональное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(8,32,2,'mediumroom',' просторное и функциональное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(9,33,3,'largeroom','просторное и роскошное место, где ваш любимец сможет наслаждаться комфортом и уютом',1),(10,41,1,'smallroom',' уютное и комфортное место, где ваш любимец сможет отдохнуть и расслабиться',1);
...
CREATE TABLE `services` (
  ...
  `serviceimage` varchar(45) DEFAULT NULL,
...
INSERT INTO `services` VALUES (1,1,'Проживание','Проживание в номере гостиницы без оказания доп услуг',200,NULL),(2,1,'Проживание+','Проживание в номере гостиницы с выгуливанием питомца',350,'bookingplus'),(3,2,'Лечение и уход','За вашим питомцем будет наблюдать один из сотрудников, следить за его поведением, измерять температуру, давать необходимые лекарства',150,'medicine'),(4,3,'Фотосессия','Сделаем и отправим Вам фотографи и видео с вашим любимым питомцем',500,'photosession');
...
-- Dump completed on 2024-03-12  0:51:00
